# This file is to read gated image and gt data.
...
# 720, 1280, 3 
def read_rgb_image(base_dir, gta_pass, img_id, data_type, num_bits=10, scale_images=False,
                     scaled_img_width=None, scaled_img_height=None,
                     normalize_images=False):
    #gated_imgs = []
    normalizer = 2 ** num_bits - 1.

    gate_dir = os.path.join(base_dir, gta_pass, 'rgb_left')
